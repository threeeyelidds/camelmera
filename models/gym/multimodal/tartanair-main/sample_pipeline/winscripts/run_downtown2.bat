...
set env=ModernCityDowntownExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\ModernCityDowntownExposure\ModernCityDowntown\Content\buffered_id_map_ModernCityMap01.json
