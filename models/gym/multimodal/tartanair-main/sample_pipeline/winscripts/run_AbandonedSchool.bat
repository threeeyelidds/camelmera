...
set env=AbandonedSchoolExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\AbandonedSchoolExposure\AbandonedSchool\Content\buffered_id_map_DemoMap_main_noautoexpo.json
