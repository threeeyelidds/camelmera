...
set env=OldTownSummerExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\OldTownSummerExposure\OldTown\Content\buffered_id_map_Demo.json
...
set posedir=C:\tartanair-v2\trajs\oldtown
set outputdir=E:\
...
@REM CHANGE THE FOLLOWING PARAMETERS
set env=OldTownFallExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\OldTownFallExposure\OldTown\Content\buffered_id_map_Demo_Fall.json
...
@REM CHANGE THE FOLLOWING PARAMETERS
set env=OldTownWinterExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\OldTownWinterExposure\OldTown\Content\buffered_id_map_DEmo_winter.json
...
@REM CHANGE THE FOLLOWING PARAMETERS
set env=OldTownNightExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\OldTownNightExposure\OldTown\Content\buffered_id_map_Demo_Night.json
