...
set env=Slaughter
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\Slaughter\SlaughterHouse\Content\buffered_id_map_SlaughterHouse_demo.json
...
cd /d %codedir%
start /wait python -m collection.collect_images --environment-dir %outputdir%\%env% --posefile-folder %posedir%\%env%\pose_easy --data-folder Data_easy --cam-list 0_1_2_3_4_5_6_7_8_9_10_11 --dyna-time 0.05
start /wait python -m collection.collect_images --environment-dir %outputdir%\%env% --posefile-folder %posedir%\%env%\pose_hard --data-folder Data_hard --cam-list 0_1_2_3_4_5_6_7_8_9_10_11 --dyna-time 0.05
