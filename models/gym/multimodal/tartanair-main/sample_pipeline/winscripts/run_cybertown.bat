...
set env=CyberPunkDowntownExposure
set gamma=1.0
set seglabel=C:\tartanair-v2\Package\CyberPunkDowntownExposure\CyberPunkDowntown\Content\buffered_id_map_Demo_Level.json
