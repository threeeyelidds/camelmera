...
# --node-range-zmax 2
# --graph-filename node80_edge10_len10_30.graph

# # step 2
# python $SCRIPT \
# --sample-path \
# --graph-filename /home/sakura/tmp/maps/blocks/OccMap/node80_edge10_len10_30.graph \
# --environment-dir $ENVDIR \
# --sample-cycle-mode 0 \
...
# python $SCRIPT \
# --sample-position \
# --ros-path-dir "/home/sakura/tmp/maps/blocks/ros_path_0521_015058" \
# --environment-dir $ENVDIR \
...
# --environment-dir $ENVDIR \
# --position-folder "/home/sakura/tmp/maps/blocks/position_easy" \
# --data-folder-suffix easy \
# --rand-degree 60 \
# --smooth-count 20 \
# --max-pitch 30 \
# --min-pitch -45 \
