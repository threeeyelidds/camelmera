MAPNAME=modurbancity
ENVDIR=/home/wenshan/tmp/v2maps/${MAPNAME}
...
# --min-dist-thresh 10 \
# --max-dist-thresh 30 \
# --node-range-xmin -50.0 \
# --node-range-xmax 50.0 \
# --node-range-ymin -70.0 \
# --node-range-ymax 70.0 \
# --node-range-zmin -4 \
# --node-range-zmax 2 
...
# python $SCRIPT \
# --sample-position \
# --ros-path-dir ros_path_0519_211544 \
# --environment-dir $ENVDIR \
