...
class CQLAgent():
    ...
    def learn(self, experiences):
        ...
        actions = torch.cat(actions).to(self.device).view(-1, 1) # Reshape action space
        ...
        Q_expected = Q_a_s.gather(1, actions.long())  # Ensure actions tensor has the correct data type
